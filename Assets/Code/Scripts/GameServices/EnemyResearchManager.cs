...
{
    public class EnemyResearchManager : ITickable
    {
        ...
        public EnemyResearchManager(EnemyLevelingConfiguration levelingConfiguration, IObjectResolver objectResolver)
        {
